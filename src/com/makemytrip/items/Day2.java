...
public class Day2 {
	...
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.chrome.driver", "D:\\Day Shift\\Selenium_Prequisites\\chromedriver_win32\\chromedriver.exe");
...
//		driver.findElement(By.id("fromCity")).sendKeys("Delhi");
		...
		driver.findElement(By.className("react-autosuggest__input")).sendKeys("Goa");
		Thread.sleep(3000);
